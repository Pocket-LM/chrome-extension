 ...
 * Dialog Root
 *
 * The main dialog component. Controls open/close state.
 */
 ...
 * Dialog Content
 *
 * The dialog modal window that appears in the center of the screen.
 */
 ...
 * Dialog Description
 *
 * Additional description text in the dialog.
 */
